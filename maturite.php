...
<div  class="red"; style="background-color:wheat"  id="print3" >
	<div class="col-md">
		...
		<h1 style="width: 100%; text-align: center;">
			<a class="btn btn-outline-info  btn-sm btn-block";  style="background-color:#fff207; text-transform: uppercase;"> <b>QUESIONNAIRE DES EXIGENCES PAR ECHELLE DE MATURITE</b> </a>
		</h1>
